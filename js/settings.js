...
function renderSettings(){
  ...
  document.getElementById('color-event').value=colors.event;
  document.getElementById('color-prio1').value=colors.prio1;
  document.getElementById('color-prio2').value=colors.prio2;
...
['event','prio1','prio2','prio3'].forEach(key=>{
  document.getElementById(`color-${key}`).addEventListener('input',e=>{
    colors[key]=e.target.value; DB.set('colors',colors); applyColors();
  });
});
